...
function Navbar() {
  ...
  const navbarBackground = theme === 'dark' ? (sticky ? 'bg-gray-600' : 'bg-gray-800') : (sticky ? 'bg-base-200' : 'bg-base-100');

  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        sticky
          ? `sticky-navbar shadow-md ${navbarBackground} duration-300 transition-all ease-in-out`
          : `${navbarBackground} transition-all ease-in-out`
      }`}
    >
